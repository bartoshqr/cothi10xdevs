...
- [x] 5.1 Integration tests pass with local Supabase up: `npm run test:integration` (or project equivalent) — 4ee0410
- [x] 5.2 Type/lint pass: `npx astro check && npm run lint` — 4ee0410

#### Manual

- [x] 5.3 Cookbook §6 entry names the two guarded regressions (42P17 helper; SETOF not-found) — 4ee0410
