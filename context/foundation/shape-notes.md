...
checkpoint:
  ...
  gray_areas_resolved:
    ...
    - topic: "mark states"
      decision: "three-state: Accept / Challenge / Abstain; Abstain counts as unresolved in the divergence summary; all three are valid re-evaluation outcomes"
